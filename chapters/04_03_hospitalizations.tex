...
We use the publicly available data from the \acrshort{rki} discussed in \Cref{sec:data} on daily reported COVID-19 cases \cite{RobertKoch-Institut2024SARSCoV2} and weekly reported hospitalizations \cite{RobertKoch-Institut2024COVID19Hospitalisierungen}. Both datasets are updated daily.
