...
Similarly, when proposing with an \acrshort{glssm} or Markov-proposal for an \acrshort{pgssm}, the weights have similar structure, see \Cref{eq:weights_markov,eq:weights_only_on_signal}, which makes calculation of $\tilde w$ efficient. 
