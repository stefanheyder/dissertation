...
\begin{theorem}[{\cite[Theorem 1.1]{Chatterjee2018Sample}}]
    \label{thm:chatterje2018Thm1}
     ...
     Let $L = \Dkl{\P}{\G} = \mathbb E \log w(Z)$ be the \acrshort{kld} between $\P$ and $\G$, and let $$\hat \P_N = \sum_{i = 1}^N w(X^i) \delta_{X^i}$$ be the particle approximation of $\P$  based on samples $X^1, \dots, X^N\iid \G$, $N \in \N$. 
