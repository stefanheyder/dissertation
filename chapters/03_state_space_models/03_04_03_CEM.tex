...
Alternatively, the improved cross-entropy method \citep{Chan2012Improved} suggests generating approximately independent samples from $\P$ by, e.g., \acrshort{mcmc}-methods, and replacing the importance sampling version of $\hat\P_{N}$  in \eqref{eq:ee_hpce} by the actual empirical distribution.
