...
\begin{tcolorbox}[title={Contributions}]
    ...
    \begin{itemize}
        \item We prove \Cref{lem:bounded-log-variance}.
        \item Discussion surrounding \citep{Chatterjee2018Sample}.
        \item We prove central limit theorems for both methods (\Cref{subsec:cem,subsec:eis}). 
        \item Proof \Cref{prop:eis-finite-sample}. 
    \end{itemize}
...
\todo{note CEM fails because it cannot work with independent marginals compared to EIS}

\todo{compare independent components exponential family}