...
Before we present these theoretical results, we want to stress the usefulness of \acrshortpl{ssm} as a flexible modeling tool for epidemiological applications. 
