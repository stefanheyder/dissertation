...
Let us start from a very general definition ofan \acrshort{ssm}.
...
\begin{figure}
    ...
    \caption{Dependency structure inan \acrshort{ssm} as given by \Cref{def:ssm}. The dependencies between observations $Y_{t-1}$ (indicated by dotted arrows) are usually not part of the standard definition ofan \acrshort{ssm}, but can be incorporated in a straightforward manner.}
