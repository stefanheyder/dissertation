...
Unless noted otherwise, all computations are performed on a Macbook Air M3 (2024) with 16GB RAM and are fitted in less than one hour of computation time. \todo{check that this is true} An exception is the larger model in \Cref{sec:regional_growth_factor_model}.
