...
\end{pmatrix}
$$
has independent marginals, and fixing an initial distribution of $X_{0}$ fully specifies an \acrshort{pgssm} for the joint distribution of $(X,Y)$. For the initial distribution we use 
$$
