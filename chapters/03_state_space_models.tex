...
$$
Thus $\hat \psi_{\text{CE}}$ is a Z-estimator and we may analyze its statistical behavior by standard methods, see e.g. \cite[Chapter 5]{VanderVaart2000Asymptotic}.
