...
\begin{example}[Negative Binomial $\operatorname{AR}(1)$ \gls{ssm}]
    ...
    $$
    where the parametrization is the one by mean and overdispersion parameter $r > 0$ \todo{ref it}.
