...
\begin{itemize}
    ...
    \item the general modeling strategy of \acrshortpl{pgssm} for epidemiological models in the same chapters, as well as \Cref{sec:modelling_epidemiological_dessiderata_with_state_space_models,sec:dessiderata}, and
