...
\begin{itemize}
    ...
    \item \textbf{methodological:} the general modeling strategy of \acrshortpl{pgssm} for epidemiological models in \Cref{cha:analysis_of_selected_models}, as well as applying the \acrshort{cem} to \acrshortpl{ssm}, and
