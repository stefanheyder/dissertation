...
# %% auto 0
__all__ = ['vmm', 'log_weights_t', 'log_weights', 'default_link', 'laplace_approximation', 'triu', 'tril', 'optimal_parameters',
...
# %% ../../nbs/4 Models/10_patch_full_dependencies.ipynb 8
def default_link(y):
...
# %% ../../nbs/4 Models/10_patch_full_dependencies.ipynb 9
# MEIS monkey patch
