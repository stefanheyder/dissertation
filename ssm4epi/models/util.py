...
# %% auto 0
__all__ = ['visualize_pgssm', 'to_log_probs', 'to_consecutive_logits', 'from_consecutive_logits', 'result_to_series']
...
# %% ../../nbs/4 Models/00_utilities.ipynb 17
def result_to_series(result, percentiles_of_interest):
