  ...
  'syms': { 'ssm4epi.ce_method': { 'ssm4epi.ce_method.ce_cholesky_block': ( '3 SSMs/07_cross_entropy_method_utils.html#ce_cholesky_block',
            ...
            'ssm4epi.models.util': { 'ssm4epi.models.util.__zero_to_nan': ( '4 Models/utilities.html#__zero_to_nan',
                                     ...
                                     'ssm4epi.models.util.from_consecutive_logits': ( '4 Models/utilities.html#from_consecutive_logits',
                                                                                      'ssm4epi/models/util.py'),
                                     'ssm4epi.models.util.result_to_series': ( '4 Models/utilities.html#result_to_series',
                                                                               'ssm4epi/models/util.py'),
                                     ...
                                     'ssm4epi.models.util.visualize_pgssm': ( '4 Models/utilities.html#visualize_pgssm',
                                                                              'ssm4epi/models/util.py')},
            'ssm4epi.patch.full_deps': { 'ssm4epi.patch.full_deps.default_link': ( '4 Models/patch_full_dependencies.html#default_link',
                                                                                   'ssm4epi/patch/full_deps.py'),
                                         'ssm4epi.patch.full_deps.gnll': ( '4 Models/patch_full_dependencies.html#gnll',
                                                                           'ssm4epi/patch/full_deps.py'),
