...
%}{biblatex}
\usepackage[backend=biber,bibencoding=utf8,language=auto,style=authoryear-comp,sorting=nyt,maxbibnames=1,natbib=true,giveninits=true,uniquelist=false]{biblatex}
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{amsthm}
