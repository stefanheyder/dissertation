% Created by tikzDevice version 0.12.6 on 2026-03-08 16:26:24
...
\path[fill=fillColor,fill opacity=0.30] (618.77, 71.33) rectangle (626.12,108.38);
\definecolor{fillColor}{RGB}{60,84,136}

\path[fill=fillColor,fill opacity=0.50] (618.77, 71.33) rectangle (626.12, 71.33);
\definecolor{fillColor}{RGB}{60,84,136}

\path[fill=fillColor] (618.77, 70.62) rectangle (626.12, 72.04);
...
\path[fill=fillColor,fill opacity=0.30] (626.12,127.68) rectangle (633.47,254.23);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor,fill opacity=0.50] (626.12,149.30) rectangle (633.47,182.00);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor] (626.12,163.38) rectangle (633.47,164.81);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.30] (633.47, 92.21) rectangle (640.83,183.70);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.50] (633.47, 99.23) rectangle (640.83,109.14);
\definecolor{fillColor}{RGB}{0,160,135}
