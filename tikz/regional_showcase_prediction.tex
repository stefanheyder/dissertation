% Created by tikzDevice version 0.12.6 on 2026-02-17 20:30:58
...
\path[fill=fillColor,fill opacity=0.30] (626.12,127.66) rectangle (633.47,253.14);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor,fill opacity=0.50] (626.12,149.47) rectangle (633.47,182.04);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor] (626.12,163.48) rectangle (633.47,164.90);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.30] (633.47, 92.19) rectangle (640.83,181.78);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.50] (633.47, 99.18) rectangle (640.83,109.14);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor] (633.47,102.88) rectangle (640.83,104.30);
