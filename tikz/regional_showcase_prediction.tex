% Created by tikzDevice version 0.12.6 on 2025-10-04 09:22:44
...
\path[fill=fillColor,fill opacity=0.30] (626.12,127.47) rectangle (633.47,251.50);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor,fill opacity=0.50] (626.12,149.51) rectangle (633.47,182.23);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor] (626.12,163.53) rectangle (633.47,164.95);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.30] (633.47, 92.19) rectangle (640.83,181.54);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.50] (633.47, 99.25) rectangle (640.83,109.12);
\definecolor{fillColor}{RGB}{0,160,135}
