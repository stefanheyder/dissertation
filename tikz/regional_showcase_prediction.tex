% Created by tikzDevice version 0.12.6 on 2025-09-25 19:59:43
...
\path[fill=fillColor,fill opacity=0.30] (626.12,127.42) rectangle (633.47,256.41);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor,fill opacity=0.50] (626.12,149.35) rectangle (633.47,182.09);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor] (626.12,163.31) rectangle (633.47,164.73);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.30] (633.47, 92.12) rectangle (640.83,185.98);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.50] (633.47, 99.25) rectangle (640.83,109.14);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor] (633.47,102.95) rectangle (640.83,104.37);
