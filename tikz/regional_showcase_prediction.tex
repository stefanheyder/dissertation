% Created by tikzDevice version 0.12.6 on 2026-02-28 16:41:31
...
\path[fill=fillColor,fill opacity=0.30] (626.12,127.49) rectangle (633.47,253.73);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor,fill opacity=0.50] (626.12,149.28) rectangle (633.47,182.04);
\definecolor{fillColor}{RGB}{77,187,213}

\path[fill=fillColor] (626.12,163.39) rectangle (633.47,164.82);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.30] (633.47, 92.17) rectangle (640.83,182.26);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor,fill opacity=0.50] (633.47, 99.23) rectangle (640.83,109.12);
\definecolor{fillColor}{RGB}{0,160,135}

\path[fill=fillColor] (633.47,102.86) rectangle (640.83,104.28);
